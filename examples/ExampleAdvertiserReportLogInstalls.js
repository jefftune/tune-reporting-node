#!/usr/bin/env node
/**
 * ExampleAdvertiserReportLogInstalls.js, Example of TUNE Reporting API.
 *
 * @module examples
 * @main tune-reporting
 *
...
try {
  ...
  async.series({
    taskStartExample: function (next) {
      ...
      console.log(' Begin: TUNE Advertiser Report Log Installs           '.blue.bold);
      console.log('======================================================'.blue.bold);
      console.log('\n');
      next();
    },
    ...
    taskFieldsRecommended: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Recommended Fields of Advertiser Report Log Installs.    ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskCount: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Count Advertiser Report Log Installs.                    ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskFind: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Find Advertiser Report Log Installs.                     ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskExportCsvReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Export Advertiser Report Log Installs CSV report.        ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskStatusCsvReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Status Advertiser Report Log Installs CSV report.        ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskFetchCsvReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Fetch Advertiser Report Log Installs CSV report.         ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskReadCsvReport: function (next) {
      ...
      console.log('\n');
      console.log('==========================================================');
      console.log(' Read Advertiser Report Log Installs CSV report.          ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskExportJsonReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Export Advertiser Report Log Installs JSON report.       ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskStatusJsonReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Status Advertiser Report Log Installs JSON report.       ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskFetchJsonReport: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Fetch Advertiser Report Log Installs JSON report.        ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskReadJsonReport: function (next) {
      ...
      console.log('\n');
      console.log('==========================================================');
      console.log(' Read Advertiser Report Log Installs JSON report.         ');
      console.log('==========================================================');
      console.log('\n');
    ...
    taskCountSessionToken: function (next) {
      console.log('\n');
      console.log('==========================================================');
      console.log(' Count Advertiser Report Log Installs session_token       ');
      console.log('==========================================================');
      console.log('\n');
